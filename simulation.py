...
def create_controlled_processes():
    ...
    """
    return [
        Process(name="P1", arrival_time=0, burst_time=6, priority=3),
        Process(name="P2", arrival_time=1, burst_time=3, priority=5),
        Process(name="P3", arrival_time=3, burst_time=8, priority=1),
        Process(name="P4", arrival_time=5, burst_time=2, priority=4),
        Process(name="P5", arrival_time=7, burst_time=5, priority=2)
    ]
